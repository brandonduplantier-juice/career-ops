...
Readmission Analysis on Snowflake
Independent Healthcare Analytics Project | Snowflake, Python | June 2026

Loaded the 300-patient readmission dataset into a Snowflake cloud data warehouse using
the Python connector (write_pandas) and analyzed it with Snowflake SQL, including IFF,
QUALIFY, RATIO_TO_REPORT, and window functions. Heart Failure had the highest readmission
rate at 39.29%; Medicare patients accounted for 48.6% of all readmissions; patients
without a scheduled followup readmitted at 30.59% versus 21.40% with followup. Created the
warehouse, database, schema, and table programmatically.
Link: github.com/brandonduplantier-juice/python-portfolio/tree/main/Snowflake-Readmission-Analysis
